...
class AbstractListReporter {
    ...
    onCheckInProgress(check, sequenceId) {
        var _a;
        const checkFile = this.checkFilesMap.get((_a = check.getSourceFile) === null || _a === void 0 ? void 0 : _a.call(check)).get(sequenceId);
    ...
    onCheckEnd(sequenceId, checkResult, testResultId, links) {
        ...
        checkStatus.checkStatus = checkResult.hasFailures ? util_1.CheckStatus.FAILED : util_1.CheckStatus.SUCCESSFUL;
