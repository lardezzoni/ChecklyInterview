...
exports.loadChecklyConfig = exports.getChecklyConfigFile = exports.loadFile = void 0;
...
function getChecklyConfigFile() {
    const filenames = ['checkly.config.ts', 'checkly.config.js', 'checkly.config.mjs'];
    let config;
    for (const configFile of filenames) {
        const dir = path.resolve(path.dirname(configFile));
        if (!(0, fs_1.existsSync)(path.resolve(dir, configFile))) {
            continue;
        }
